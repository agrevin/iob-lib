...
def create_periphs_tmp(top, periph_addr_select_bit, peripherals_list, out_file):

    template_contents = []
    for instance in peripherals_list:
        template_contents.extend("#define {}_BASE ({}_{}<<({}-{}_N_SLAVES_W))\n".format(
            instance['name'], top, instance['name'], periph_addr_select_bit, top))
